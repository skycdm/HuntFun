...
public class PublishExitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_publish_exit);
    ...
    @OnClick({R.id.join_num, R.id.eva_more, R.id.iv_back, R.id.fb_dt, R.id.tc_act, R.id.tv_evaluate, R.id.tv_evaluate_detail})
