...
public class Fragment_sport extends Fragment  implements AbsListView.OnScrollListener {
    ...
    final List<Sport> sports = new ArrayList<>();//预约
    int page=1;
...
//        });
    ...
    private void delect(String spotid) {
        Flage.FLAG = 0;
        RequestParams rp = new RequestParams(Constent.URL+"huntfunService/delectCollection?sportId="+spotid+"&flag="+ Flage.FLAG);
    ...
    private void setadapter() {
        adapter = new BaseAdapter() {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                View view1 =View.inflate(getActivity(), R.layout.collectsport,null);
...
//                thread(img,imgs);
                try {
                    ...
                    sportName.setText("活动名称："+URLDecoder.decode(sport.getSportName(),"utf-8"));
...
//                    miaoshu.setText(URLDecoder.decode(sport.theme,"utf-8"));
                ...
                change.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        delect(String.valueOf(sport.getId()));
                    }
                });
                //预约
                delect.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(getActivity(),sport.getId()+"",Toast.LENGTH_SHORT).show();
    ...
    private void geconnection(int page) {
        ...
        RequestParams params = new RequestParams(Constent.URL+"huntfunService/collection?page="+page+"");
