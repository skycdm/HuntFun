...
public class Fragment_xiaoxi extends Fragment {
    private static final int REQUESRCODE = 1;
 ...
 private void getAllDynamicList() {
       ...
       public  class DynamicAdapter extends CommonAdapter<Dynamic> {
           ...
           public void convert(ViewHolder viewHolder, Dynamic dynamic, int position) {
               ...
               if (dynamic.getPic() != null && !"".equals(dynamic.getPic())) {
               ...
               }else if ("".equals(dynamic.getPic())||dynamic.getPic() == null) {
              /*  NineGridTestLayout nine = viewHolder.getViewById(R.id.layout_nine_grid);
                nine.setVisibility(View.GONE);*/
                   System.out.println("我aaaaaaaaaaaaaaaaaaaaaaaaa");
